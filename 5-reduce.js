...
// Vamos a verlo con otro arreglo, developers: Queremos obtener un arreglo que tenga todas las habilidades en uno solo.
const developers = [
    {
        id: 1,
        name: "John",
...
El objeto Set permite almacenar valores únicos de cualquier tipo, incluso valores primitivos o referencias a objetos. Nos permite guardar todos los elementos que no se repiten. Si alguno se repite lo descarta.
También hemos visto cómo ese objeto se puede transformar en un Array con el método Array.from()
